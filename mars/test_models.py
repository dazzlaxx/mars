...
def client():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///:memory:'  #Использование временной базы данных в памяти
...
def test_user_creation(client):
    with app.app_context():  #Установка контекста приложения
        ...
        assert user.check_password('password123') is True  #Проверка, что пароль правильный
